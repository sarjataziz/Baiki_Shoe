...
include '../../Controllers/shoeControllerSeller.php';
...
<body>
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <input type="hidden" name="shoe_id" value="<?php echo $shoes["shoe_id"]; ?>">
            <fieldset>
                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="quantity" name="quantity" value="<?php echo $shoes["quantity"]; ?>"><br>
                    ...
                    <tr>
                        ...
                        <td><textarea type="text" name="description" id="text" cols="60" rows="5" value="<?php echo $shoes["description"]; ?>"></textarea><br>
                            <span style="color:red"><?php echo $error_description; ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td><label>Image: </label></td>
                        <td><input type="file" id="shoe_img" name="shoe_img" value="<?php echo $shoes["shoe_img"]; ?>"><br>

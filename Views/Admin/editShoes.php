            ...
            <fieldset>
                ...
                <table align="center">
                    <tr>
                        ...
                        <td><input type="text" id="shoe_name" name="shoe_name"
                                value="<?php echo $shoes["shoe_name"]; ?>"><br>
                        <td><input type="hidden" name="shoe_id" value="<?php echo $shoes["shoe_id"]; ?>"></td>
                    ...
                    <tr>
                        <td align="center" colspan="2"><input type="submit" name="edit_shoe" value="Save"></td>
                    </tr>
                </table>
            </fieldset>
        </form>

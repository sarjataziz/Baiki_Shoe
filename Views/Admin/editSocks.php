            ...
            <fieldset>
                ...
                <table align="center">
                    <tr>
                        ...
                        <td><input type="text" id="sock_name" name="sock_name"
                                value="<?php echo $socks["sock_name"]; ?>"><br>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="material" name="material"
                                value="<?php echo $socks["material"]; ?>"><br>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="quantity" name="quantity"
                                value="<?php echo $socks["quantity"]; ?>"><br>
                    ...
                    <tr>
                        <td align="center" colspan="2"><input type="submit" name="edit_sock" value="Save"></td>
                    </tr>
                </table>
            </fieldset>
        </form>
